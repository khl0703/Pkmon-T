...
export const POKEDEX = {
  1: { name: { ko: "이상해씨", en: "Bulbasaur" }, types: ["풀", "독"], bs: { hp: 45, atk: 49, def: 49, spa: 65, spd: 65, spe: 45 }, cr: 45, bexp: 64, moves: [{ l: 1, m: "울음소리" }, { l: 1, m: "몸통박치기" }, { l: 3, m: "덩굴채찍" }, { l: 6, m: "성장" }] },
  4: { name: { ko: "파이리", en: "Charmander" }, types: ["불꽃"], bs: { hp: 39, atk: 52, def: 43, spa: 60, spd: 50, spe: 65 }, cr: 45, bexp: 62, moves: [{ l: 1, m: "울음소리" }, { l: 1, m: "할퀴기" }, { l: 4, m: "불꽃세례" }, { l: 8, m: "연막" }] },
  7: { name: { ko: "꼬부기", en: "Squirtle" }, types: ["물"], bs: { hp: 44, atk: 48, def: 65, spa: 50, spd: 64, spe: 43 }, cr: 45, bexp: 63, moves: [{ l: 1, m: "몸통박치기" }, { l: 1, m: "꼬리흔들기" }, { l: 3, m: "물대포" }, { l: 6, m: "껍질에숨기" }] },
